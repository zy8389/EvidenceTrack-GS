...
R1-4：旧工作的继承部分是否存在重复贡献或自引遗漏？回复：内部文档明确固定 GeoTrack-GS 提交与 Phase2.1 来源；投稿前须核对作者已发表论文并第三人称引用、说明新增内容。由于当前未拿到经核对的最终出版条目，不编造作者论文的刊名、页码或 DOI。状态：部分解决，出版信息与重合度核对仍待作者补证。
