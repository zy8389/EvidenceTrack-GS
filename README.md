...
This private repository preserves the reproducible research overlay, cumulative patch, protocols, documentation, experiment matrix, and integrity manifest. It deliberately excludes manuscript materials, datasets, pretrained weights, checkpoints, caches, and generated experiment outputs.
