...
def validate_overlay_contract(root):
    checkpoint=(root/'diffusion_guidance/checkpoint_state.py').read_text(encoding='utf-8')
    for anchor in (
    ...
    pseudo=(root/'diffusion_guidance/pseudo_manifest.py').read_text(encoding='utf-8')
    for anchor in (
        '"manifest_schema"',
        '"track_h5"',
        '"source_camera_names"',
    ...
    identity=(root/'diffusion_guidance/control_identity.py').read_text(encoding='utf-8')
    for anchor in (
    ...
    checkpoint_provenance=(
        root/'diffusion_guidance/checkpoint_state.py'
    ...
    result_binding=(
        root/'diffusion_guidance/result_binding.py'
    ).read_text(encoding='utf-8')
    for anchor in (
    ...
    difix=(root/'diffusion_guidance/difix_provenance.py').read_text(encoding='utf-8')
    ...
    evidence=(root/'diffusion_guidance/evidence_protocol.py').read_text(encoding='utf-8')
    for anchor in (
    ...
    association=(root/'tools/compare_identity_reports.py').read_text(encoding='utf-8')
    ...
    geometry=(root/'geometric_constraints/repaired_geometry.py').read_text(encoding='utf-8')
    for anchor in (
...
def main():
    ...
    required_overlay=(
        ...
        'diffusion_guidance/checkpoint_state.py',
        'diffusion_guidance/control_identity.py',
        'diffusion_guidance/difix_provenance.py',
        'diffusion_guidance/evidence_protocol.py',
        'diffusion_guidance/pseudo_schedule.py',
        'diffusion_guidance/result_binding.py',
        'geometric_constraints/repaired_geometry.py',
        'geometric_constraints/strict_track_store.py',
        'tools/compare_identity_reports.py',
        'tools/make_paired_identity_manifest.py',
    )
    ...
    for name,calibration_call,expected_count in calibrated_tools:
        path=r/'tools'/name;text=path.read_text(encoding='utf-8')
        ...
        ast.parse(text)
    path=r/'tools'/'test_geometry_recovery.py';text=path.read_text(encoding='utf-8')
